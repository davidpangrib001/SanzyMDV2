...
const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "6289523258649-1604595598@g.us"}, "message": {orderMessage: {itemCount: 2021,status: 200, thumbnail: fs.readFileSync('./image/sanzy2.jpg'), surface: 200, message: `One`, orderTitle: 'Halo', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
...
respon = `
Waktu Merespon: ${latensi.toFixed(4)} _Second_ \n ${oldd - neww} _miliseconds_\n\nRuntime : ${runtime(process.uptime())}
...
let buttonMessage3 = {
text: `Tidak Menerima save, Tidak menelepon onwer, to the point aja, jangan spam onwer. `,
...
hydratedFooterText: `One Bot by Dapitt`,
hydratedButtons: [{
urlButton: {
displayText: 'Res Api',
...
if (budy.includes('6282160268332')) {  
